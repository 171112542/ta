...
class CourseQuestionDiffCallback : DiffUtil.ItemCallback<AssignmentQuestion>() {
    override fun areItemsTheSame(oldItem: AssignmentQuestion, newItem: AssignmentQuestion): Boolean {
        return oldItem.id == newItem.id
    }

    override fun areContentsTheSame(oldItem: AssignmentQuestion, newItem: AssignmentQuestion): Boolean {
