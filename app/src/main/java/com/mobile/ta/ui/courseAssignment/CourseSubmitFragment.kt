...
import com.mobile.ta.viewmodel.courseAssignment.CourseSubmitViewModel
...
class CourseSubmitFragment : Fragment() {
    ...
    private fun setupPage() {
        viewmodel.submittedAssignment.observe(viewLifecycleOwner) {
            ...
            binding.fragCourseSubmitScore.text = getString(R.string.assignment_result_text, correctAnswerCount, totalAnswerCount)
        }
