...
import com.mobile.ta.data.UserCourseData
...
class CourseTabViewModel @ViewModelInject constructor(
    ...
    init {
        _userOngoingCourse.value = UserCourseData.userOngoingCourse
        _userFinishedCourse.value = UserCourseData.userFinishedCourse
    }
}